...
"""
experiment：compare RT/PRQT/BRINS/STUSLI/STUBRIN performance
"""
if __name__ == '__main__':
    ...
    # data_distributions = [Distribution.NYCT_SORTED, Distribution.NORMAL_SORTED, Distribution.UNIFORM_SORTED, Distribution.SKEW_SORTED]
    ...
    for data_distribution in data_distributions:
        ...
        for index_info in index_infos:
            ...
            #load index structure to memory
            if index_info[0] in [STUSLI, STUBRIN]:
            ...
            for j in range(len(update_data_list)):
                ...
                # query 5 time, discarding the slowest and fastest, and averaging the remaining three
