...
if __name__ == '__main__':
    ...
    origin_path = "model/"
    target_path = "model/compare_stubrin/"
    ...
    index_infos = [
        # tel
        ("stubrin_0.8_1_1.1", True, -1, 6, True, True, -1, 6, False, False, 0.8, 1, 1.1, True),
        ("stubrin_0.9_1_1.1", True, -1, 6, True, True, -1, 6, False, False, 0.9, 1, 1.1, False),
        ("stubrin_1.0_1_1.1", True, -1, 6, True, True, -1, 6, False, False, 1.0, 1, 1.1, False),
        ("stubrin_1.1_1_1.1", True, -1, 6, True, True, -1, 6, False, False, 1.1, 1, 1.1, False),
        ("stubrin_1.2_1_1.1", True, -1, 6, True, True, -1, 6, False, False, 1.2, 1, 1.1, False),
        # tef
        ("stubrin_1.1_0_1.1", False, -1, 6, False, True, -1, 6, False, False, 1.1, 0, 1.1, False),
        # ("stubrin_1.1_1_1.1", False, -1, 6, False, True, -1, 6, False, False, 1.1, 1, 1.1, False),
        ("stubrin_1.1_2_1.1", False, -1, 6, False, True, -1, 6, False, False, 1.1, 2, 1.1, False),
        ("stubrin_1.1_4_1.1", False, -1, 6, False, True, -1, 6, False, False, 1.1, 4, 1.1, False),
        ("stubrin_1.1_8_1.1", False, -1, 6, False, True, -1, 6, False, False, 1.1, 8, 1.1, False),
        # ten
        ("stubrin_1.1_1_0.8", False, -1, 6, False, True, -1, 6, False, False, 1.1, 1, 0.8, False),
        ("stubrin_1.1_1_0.9", False, -1, 6, False, True, -1, 6, False, False, 1.1, 1, 0.9, False),
        ("stubrin_1.1_1_1.0", False, -1, 6, False, True, -1, 6, False, False, 1.1, 1, 1.0, False),
        # ("stubrin_1.1_1_1.1", False, -1, 6, False, True, -1, 6, False, False, 1.1, 1, 1.1, False),
        ("stubrin_1.1_1_1.2", False, -1, 6, False, True, -1, 6, False, False, 1.1, 1, 1.2, False),
        # rm
        ("stusli_1.1_1_1.1", True, -1, 6, True, True, -1, 6, False, False, 1.1, 1, 1.1, True),
        ("stusli_1.1_1_1.1", True, -1, 6, True, True, -1, 6, False, True, 1.1, 1, 1.1, False),
        # ("stubrin_1.1_1_1.1", True, -1, 6, True, True, -1, 6, False, False, 1.1, 1, 1.1, False),
        ("stubrin_1.1_1_1.1", True, -1, 3, True, True, -1, 3, False, True, 1.1, 1, 1.1, False),
    ]
    ...
    for data_distribution in data_distributions:
        ...
        for index_info in index_infos:
            if index_info[0].startswith("stusli"):
