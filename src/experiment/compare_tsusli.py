...
if __name__ == '__main__':
    ...
    target_path = "model/compare_stusli/"
    ...
    index_infos = [
        ...
        # predict_step
        # ("stusli_24_1_100_1_var_es", False, -1, 6, False, False, -1, 6, False, 24, 1, 100, 1, "var", "es", False, 0, False),
        # ("stusli_24_6_100_1_var_es", False, -1, 6, False, False, -1, 6, False, 24, 6, 100, 1, "var", "es", False, 0, False),
        # ("stusli_24_12_100_1_var_es", False, -1, 6, False, False, -1, 6, False, 24, 12, 100, 1, "var", "es", False, 0, False),
        # ("stusli_24_18_100_1_var_es", False, -1, 6, False, False, -1, 6, False, 24, 18, 100, 1, "var", "es", False, 0, False),
        # ("stusli_24_24_100_1_var_es", False, -1, 6, False, False, -1, 6, False, 24, 24, 100, 1, "var", "es", False, 0, False),
        # bs
        # ("stusli_24_12_100_1_var_es", False, -1, 6, False, False, -1, 6, False, 24, 12, 100, 1, "var", "es", False, 0, False),
        # ("stusli_24_12_100_146_var_es", False, -1, 6, False, False, -1, 6, False, 24, 12, 100, 146, "var", "es", False, 0, False),
        # ("stusli_24_12_100_292_var_es", False, -1, 6, False, False, -1, 6, False, 24, 12, 100, 292, "var", "es", False, 0, False),
        # ("stusli_24_12_100_438_var_es", False, -1, 6, False, False, -1, 6, False, 24, 12, 100, 438, "var", "es", False, 0, False),
        # ("stusli_24_12_100_584_var_es", False, -1, 6, False, False, -1, 6, False, 24, 12, 100, 584, "var", "es", False, 0, False),
        # cdf_width
        # ("stusli_24_12_10_1_var_es", False, -1, 6, False, False, -1, 6, False, 24, 12, 10, 1, "var", "es", False, 0, False),
        # ("stusli_24_12_50_1_var_es", False, -1, 6, False, False, -1, 6, False, 24, 12, 50, 1, "var", "es", False, 0, False),
        # ("stusli_24_12_100_1_var_es", False, -1, 6, False, False, -1, 6, False, 24, 12, 100, 1, "var", "es", False, 0, False),
        # ("stusli_24_12_250_1_var_es", False, -1, 6, False, False, -1, 6, False, 24, 12, 250, 1, "var", "es", False, 0, False),
        # ("stusli_24_12_500_1_var_es", False, -1, 6, False, False, -1, 6, False, 24, 12, 500, 1, "var", "es", False, 0, False),
        # ts model
        # ("stusli_24_12_100_1_var_es", False, -1, 6, False, True, -1, 6, True, 24, 12, 100, 1, "var", "es", False, 0, False),
        # ("stusli_24_12_100_1_var_sarima", False, -1, 6, False, False, -1, 6, False, 24, 12, 100, 1, "var", "sarima", False, 0, False),
        # ("stusli_24_12_100_1_var_rnn", False, -1, 6, False, False, -1, 6, False, 24, 12, 100, 1, "var", "rnn", False, 0, False),
        # ("stusli_24_12_100_1_var_lstm", False, -1, 6, False, True, -1, 6, True, 24, 12, 100, 1, "var", "lstm", True),
        # ("stusli_24_12_100_1_var_gru", False, -1, 6, False, False, -1, 6, False, 24, 12, 100, 1, "var", "gru", False, 0, False),
        # sts model
        # ("stusli_24_12_100_1_var_es", False, -1, 6, False, True, -1, 6, True, 24, 12, 100, 1, "var", "es", False, 0, False),
        # ("stusli_24_12_100_1_fclstm_es", False, -1, 6, False, False, -1, 6, False, 24, 12, 100, 1, "fclstm", "es", False, 0, False),
        # ("stusli_24_12_100_1_convlstm_es", False, -1, 6, False, False, -1, 6, False, 24, 12, 100, 1, "convlstm", "es", False, 0, False),
        # compare update among dtusli/ipusli/stusli
        # ("dtusli", False, -1, 6, False, 146, False, 0),
        # ("ipusli", False, -1, 6, False, 0.2, False, 0),
        # ("ipusli2", False, -1, 6, False, 0.8, False, 0),
        # ("stusli_24_12_100_1_var_es", False, -1, 6, False, False, -1, 6, False, 24, 12, 100, 1, "var", "es", False, 0, False),
        # compre retrain among dtusli/ipusli/stusli
    ...
    for data_distribution in data_distributions:
        ...
        for index_info in index_infos:
            ...
            elif index_info[0].startswith("stusli"):
                index = STUSLI(model_path=target_model_path)
                super(STUSLI, index).load()
                index.build_append(time_interval=60 * 60,
                                   start_time=1356998400,
                                   end_time=1359676799,
                                   lag=index_info[9],
