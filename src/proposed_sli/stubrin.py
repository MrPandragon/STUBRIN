...
class STUBRIN(SLBRIN):
    ...
    def update(self):
        ...
        if self.is_retrain and self.time_id > self.time_retrain:
            ...
            time_model_path = os.path.join(self.model_path, "../stubrin_time_model", str(self.time_id),
        ...
        if self.is_retrain_delta and self.time_id > self.time_retrain_delta:
            ...
            time_model_path = os.path.join(
                self.model_path, "../stubrin_time_model", str(self.time_id),
    ...
    def size(self):
        ...
        ie_size
        """
        structure_size, ie_size = super(STUBRIN, self).size()
